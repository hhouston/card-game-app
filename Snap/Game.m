...
- (id)init
{
	if ((self = [super init]))
	{
		...
		_matchingPlayers = [NSMutableSet setWithCapacity:2];
	}
	return self;
}
...
- (void)startSinglePlayerGame
{
	...
	player.name = NSLocalizedString(@"Alex", @"Single player mode, name of left player");
	player.peerID = @"2";
	player.position = PlayerPositionLeft;
	[_players setObject:player forKey:player.peerID];

//	player = [[Player alloc] init];
//	player.name = NSLocalizedString(@"Leslie", @"Single player mode, name of top player");
//	player.peerID = @"3";
//	player.position = PlayerPositionTop;
//	[_players setObject:player forKey:player.peerID];
//
//	player = [[Player alloc] init];
//	player.name = NSLocalizedString(@"Hunter", @"Single player mode, name of right player");
//	player.peerID = @"4";
//	player.position = PlayerPositionRight;
//	[_players setObject:player forKey:player.peerID];
